        ...
        <div id="delivery-note-zone" className="bg-white text-black p-8 font-sans" style={{ width: '210mm', minHeight: '297mm', margin: 'auto' }}>
            <header>
                <div className="flex justify-between items-start mb-8">
                    <div className="flex items-center space-x-4">
                        <img src={companyInfo.logoUrl || '/logo.png'} alt="Company Logo" className="h-20 w-auto" crossOrigin="anonymous" />
                        <div>
            ...
            <main>
                <table className="w-full mb-8 text-sm border-collapse border border-gray-200">
                    ...
                    <tfoot>
                        <tr className="bg-gray-100">
                            <td className="p-3 border border-gray-200 font-bold text-right uppercase text-xs">Total Quantité</td>
                            <td className="p-3 border border-gray-200 font-bold text-center text-lg">{sale.items.reduce((sum, item) => sum + item.quantity, 0)}</td>
