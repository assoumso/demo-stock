...
import { TransferListPrint } from '../components/TransferListPrint';
            ...
            <div className="lg:col-span-2">
                 <div className="flex justify-between items-center mb-4">
                    ...
                    <div className="flex items-center space-x-2">
                        <select value={limitCount} onChange={(e) => setLimitCount(Number(e.target.value))} className="px-3 py-2 border rounded-xl dark:bg-gray-700 dark:border-gray-600 font-bold">
                        ...
                        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tfoot className="border-t-2 border-gray-200 dark:border-gray-700">
                                <tr className="bg-blue-50 dark:bg-blue-900/20">
                                    <td colSpan={2} className="px-6 py-3 text-right text-xs font-black uppercase text-gray-500">Total Volume Page</td>
                                    <td className="px-6 py-3 text-sm font-black text-gray-900 dark:text-white">{totalPageVolume}</td>
                                    <td colSpan={3}></td>
                                </tr>
                                <tr className="bg-gray-100 dark:bg-gray-800">
                                    <td colSpan={2} className="px-6 py-3 text-right text-xs font-black uppercase text-gray-500">Total Volume Global</td>
                                    <td className="px-6 py-3 text-sm font-black text-gray-900 dark:text-white">{totalGlobalVolume}</td>
                                    <td colSpan={3}></td>
                                </tr>
                            </tfoot>
                        </table>
