...
/**
 * Quote line item (same as SaleItem but kept separate for clarity)
 */
...
export interface Quote {
  ...
  notes?: string;
  createdByUserId: string;
  convertedSaleId?: string; // ID of the sale if converted
  convertedPurchaseId?: string; // ID of the purchase if converted
}
