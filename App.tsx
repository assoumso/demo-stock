...
const ProductPrintPage = lazy(() => import('./pages/ProductPrintPage'));
...
const SupplierCreditNotesPage = lazy(() => import('./pages/SupplierCreditNotesPage'));
...
const AppRoutes: React.FC = () => {
    ...
    const { companyName } = useTheme(); // Move useTheme here
    ...
    return (
        <Routes>
            ...
            <Route path="/" element={<ProtectedRoute><MainLayout /></ProtectedRoute>}>
                ...
                <Route path="quotes/edit/:id" element={<QuoteFormPage />} />
                ...
                <Route path="supplier-credit-notes/new" element={<SupplierCreditNoteFormPage />} />
